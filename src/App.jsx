...
const App = () => {
  return (
    <div className="min-h-screen bg-[#F6F6F3] flex">
      <aside className="w-87.5 fixed top-0 left-0 h-screen mb-5 py-4 px-3 bg-[#F6F6F3]">
        <SideBar />
      </aside>

      <main className="flex-1 ml-85 py-6 px-3 grid grid-cols-6 grid-rows-[auto_1fr_1fr_1fr] gap-4">
        <div className="col-span-6">
          <StatsCard />
        </div>

        <div className="col-span-3 row-span-3 bg-white rounded-2xl shadow-sm p-6 overflow-hidden">
          <Customer />
        </div>
